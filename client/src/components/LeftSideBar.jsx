...
const LeftSideBar = ({ isCollapsed, navBox, panel, setinfo }) => {
  ...
  return (
    <div
      className={`${isCollapsed ? "w-30" : "w-120"} flex h-full bg-zinc-900 text-white flex-col justify-between border-r-2 border-purple-900 shrink-0 transition-all duration-300`}
    >
      <div
